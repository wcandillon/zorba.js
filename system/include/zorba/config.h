...
// Platform functions
#define ZORBA_HAVE_CLOCKGETTIME_FUNCTION
#define ZORBA_HAVE_RUSAGE_FUNCTION
...
#define ZORBA_SIZEOF_LONG          8
#define ZORBA_SIZEOF_LONG_LONG     8
#define ZORBA_SIZEOF_POINTER       8
#define ZORBA_SIZEOF_SHORT         2
#define ZORBA_SIZEOF_SIZE_T        8
...
/* #undef ZORBA_CXX_NULLPTR */
/* #undef ZORBA_CXX_STATIC_ASSERT */
...
// Version
#define ZORBA_VERSION "2.7.0"
#define ZORBA_MAJOR_NUMBER 2
#define ZORBA_MINOR_NUMBER 7
#define ZORBA_PATCH_NUMBER 0
#define ZORBA_CORE_URI_DIR "share/zorba/uris/core/2.7.0"
#define ZORBA_CORE_LIB_DIR "lib/zorba/core/2.7.0"
